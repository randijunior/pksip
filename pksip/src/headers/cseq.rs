...
use crate::{error::Result, headers::HeaderParser, message::SipMethod, parser::Parser};

/// The `CSeq` SIP header.
///
/// Ensures order and tracking of SIP TransactionLayer within a
/// session.
///
/// # Examples
///
...
impl<'a> HeaderParser<'a> for CSeq {
